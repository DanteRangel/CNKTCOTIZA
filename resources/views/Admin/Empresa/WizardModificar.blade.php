...
$contacto=$clientes[0]['direccion'][0]['contacto'];
//echo $direccion."<br>";
//echo $contacto."<br>";
...
//action="{{ url('admin/user/UserController/{'.$clientes['id'].'}') }}"
  </script>

  <div class="row-fluid center-block">
      <form  action="{{ url('admin/user/UserController/'.$clientes['id'].'') }}"  method="POST"  class="form-horizontal form-span-left" >
 ...
 <div id="wizard" class="form_wizard wizard_horizontal">
                    ...
                    <div id="step-1" class="wizard_content" style="display: block;">
                                              ...
                                              <div class="col-md-4 col-xs-12 col-sm-4">    
                                                 ...
                                                 <input  type="text" name="Nombres" class="form-control" id="Nombres" placeholder="Nombres" value="{{ $clientes['nombres'] }}"    required>
                                              </div>
                                              </div>
                                              <div class="col-md-4 col-xs-12 col-sm-4">
                                              ...
                                              <div class="item form-group ">
                                                 ...
                                                 <input type="text" name="ApellidoPaterno" class="form-control" placeholder="ApellidoPaterno" value="{{ $clientes['apellidoPaterno'] }}" required>
                                              </div>
                                              </div>
                                                <div class="col-md-4 col-xs-12 col-sm-4">
                                              <div class="item form-group ">
                                                 <span for="ApellidoMaterno"> Apellido Materno </span>
                                                 <input type="text" name="ApellidoMaterno" class="form-control" placeholder="Apellido Materno" value="{{ $clientes['apellidoMaterno'] }}" required ="optional">
                                              </div>
                                            </div>
                                          </div><br>
                                          <div class="row-fluid">
                                            ...
                                            <div class="col-md-4 col-xs-12 col-sm-4">
                                              <div class="item form-group ">
                                                 ...
                                                 <input type="text" name="CURP" class="form-control" placeholder="CURP" value="{{ $clientes['CURP'] }}" required ="optional">
                                              </div>
                                            </div>
                                            <div class="col-md-4 col-xs-12 col-sm-4">
                                              ...
                                              <div class="item form-group ">
                                                 ...
                                                 <input   type="text" name="NoSeguroSocial" class="form-control" placeholder="Numero de Seguro Social" value="{{ $clientes['NoSeguroSocial'] }}" required ="optional">
                                              </div>
                                              ...
                                              <div class="item form-group ">
                                                 ...
                                                 <input type="text" name="RFC" class="form-control" placeholder="RFC" value="{{ $clientes['RFC'] }}" required ="optional">
                                              </div>
                                            </div>
                                          ...
                                          <div class="row-fluid">
                                            ...
                                            <div class="col-md-4 col-xs-12 col-sm-4">
                                              ...
                                              <div class="item form-group ">
                                                 ...
                                                 <input   type="text" name="id_Trabajador" class="form-control" placeholder="Numero de Trabajador  Podria ser el CURP" value="{{ $clientes['id_Trabajador'] }}" required>
                                              </div>
                                              ...
                                              <div class="item form-group ">
                                                ...
                                                <select id="TipoPermiso" class="form-control" name="TipoPermiso" onchange="AparcerElementos()">
                                                    ...
                                                    <option value="0" {{ ($clientes['TipoPermiso']!=1 ||$clientes['TipoPermiso']!=2 )? 'selected':''}}>Sin Permiso - Solo Empleado</option>
                                                    <option value="2" {{ ($clientes['TipoPermiso']==2  )? 'selected':''}}>Permiso Administrador</option>
                                                    <option value="1"{{ ($clientes['TipoPermiso']==1 )? 'selected':''}}>Permiso Cotizacion</option>
                                                </select>
                                              </div>
                                            </div>
                                            </div>
